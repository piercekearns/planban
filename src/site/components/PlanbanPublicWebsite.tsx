...
export const PlanbanPublicWebsite = () => {
  ...
  useEffect(() => {
    ...
    const draw = (time: number) => {
      ...
      const glowRadius = 118 + speedFactor * 20;
      ...
      if (revealIntensity > 0.012) {
        const cell = 16;
        const radius = 126 + speedFactor * 16;
      ...
      <main id="top">
        <section className="pb-hero">
          ...
          <div className="pb-hero-visual">
            <div className="pb-hero-frame pb-grid-frame pb-grid-frame-hero">
        ...
        <section id="context" className="pb-import-section pb-section-full">
          <div className="pb-section-heading compact stacked">
            <div>
              <p className="pb-kicker">Side by side</p>
        ...
        <section id="future" className="pb-future-full">
          ...
          <div className="pb-platforms pb-grid-frame pb-grid-frame-future">
